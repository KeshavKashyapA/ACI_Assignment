...
"""
The output value of 2 from the code is the actual maximum number of nodes that were in memory 
(in the open list) at any point during the execution of the A* algorithm for your specific graph and specific run. 
This is an empirical measure of space usage for that particular execution and input.
"""